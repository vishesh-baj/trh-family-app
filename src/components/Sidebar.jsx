  ...
  return (
    <React.Fragment>
      ...
      <div
        className={`${
          !isOpen && "hidden"
        } z-50  absolute md:static md:flex md:flex-col w-64 h-screen py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600 transition duration-300 ease-in-out`}
      >
        {/* Cancel button */}
        <svg
          onClick={() => setIsOpen(!isOpen)}
